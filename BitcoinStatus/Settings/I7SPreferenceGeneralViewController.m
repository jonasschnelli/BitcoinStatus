...
- (void)awakeFromNib {
    [self.currencySelector addItemsWithObjectValues:[NSArray arrayWithObjects:NSLocalizedString(@"BSCurrencyUSD", @"usd currency string"), NSLocalizedString(@"BSCurrencyEUR", @"EUR currency string"), NSLocalizedString(@"BSCurrencyCHF", @"CHF currency string"), nil]];
